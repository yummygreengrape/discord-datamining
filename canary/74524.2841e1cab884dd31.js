...
(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    ["74524"], {
        ...
        713517(e, t, n) {
            ...
            function l(e) {
                let [t, n] = r.useState(!1), [l, s] = r.useState(!1), o = (0, i.bG)([a.A], () => a.A.keyboardModeEnabled);
                r.useEffect(() => {
                    let t = e.current;
                    if (null == t) return;
                    n(!1), s(!1);
                    ...
                    return t.addEventListener("mouseenter", r), t.addEventListener("mouseleave", i), t.addEventListener("focusin", a), t.addEventListener("focusout", l), () => {
                        t.removeEventListener("mouseenter", r), t.removeEventListener("mouseleave", i), t.removeEventListener("focusin", a), t.removeEventListener("focusout", l)
                    }
                }, [e]);
                let u = o && l;
                return {
        ...
        172799(e, t, n) {
            ...
            var r, i, a, l = ((r = {})[r.GUILD = 0] = "GUILD", r[r.GROUP_DM = 1] = "GROUP_DM", r[r.FRIEND = 2] = "FRIEND", r);
            let s = new Set([0, 1]);
            var o = ((i = {})[i.STREAM = 1] = "STREAM", i[i.EMBEDDED_APPLICATION = 2] = "EMBEDDED_APPLICATION", i[i.ROLE_SUBSCRIPTIONS_PURCHASE = 3] = "ROLE_SUBSCRIPTIONS_PURCHASE", i),
        ...
        658128(e, t, n) {
            ...
            function h(e) {
                let t = o.A.getChannelId(e),
                    n = s.Ay.getDefaultChannel(e)?.id ?? function(e) {
                        if (e !== d.ME) return;
                        let t = u.default.getPrivateChannelIds();
                        return t.length > 0 ? t[0] : void 0
                    }(e);
                return (t !== c.VV.GUILD_ONBOARDING || r.Ay.shouldShowOnboarding(e)) && (t !== c.VV.GUILD_HOME || (0, i.K)(e)) ? t === c.VV.GAME_SHOP && (0, a.Ye)(e) ? t : null == l.A.getChannel(t) ? n : t : n
            }
        },
        342296(e, t, n) {
            n.d(t, {
            ...
            function E(e) {
                let {
                    ...
                    shouldPreload: k = !0,
                    ...L
                } = e, b = i.useRef(void 0), T = i.useCallback(() => null != C ? C() : (0, d.A)(n.id, g ?? n.getAvatarURL(l, p), {
                    type: "popout",
                    withMutualGuilds: n.id !== a.id,
                    withMutualFriends: !n.bot && n.id !== a.id,
                    guildId: l,
                    channelId: u
                }), [C, a, n, g, l, u]), K = i.useCallback(e => (b.current = Date.now(), null != v) ? v(e, b.current) : (0, r.jsx)(c.A, {
                    ...e,
                    user: n,
                    currentUser: a,
                    guildId: l,
            ...
            let _ = i.memo(function(e) {
                let {
                    ...
                    user: i,
                    ...l
                } = e, s = (0, a.bG)([u.default], () => u.default.getCurrentUser()), o = (0, a.bG)([u.default], () => i ?? u.default.getUser(n));
                return null == o || null == s ? t(f, m) : (0, r.jsx)(E, {
                    ...l,
                    user: o,
                    currentUser: s,
                    children: t
        ...
        284016(e, t, n) {
            ...
            class d extends a.Ay.PersistedStore {
                ...
                static migrations = [() => {
                    ...
                    let n = {};
                    return !1 === e[o.nc_.TEXT] && (n.text = {
                        shouldSync: !1,
                        settings: i().pick(t, ["inlineAttachmentMedia", "inlineEmbedMedia", "renderEmbeds", "renderReactions", "animateEmoji", "animateStickers", "gifAutoPlay", "defaultReactionEmoji"])
                    }), !1 === e[o.nc_.APPEARANCE] && (n.appearance = {
                        shouldSync: !1,
                        settings: i().pick(t, ["theme", "clientThemeSettings", "developerMode"])
                    }), n
                }, e => {
                    if (e?.appearance?.settings?.theme === "amoled") return {
                        ...e,
                        appearance: {
                            ...e.appearance,
                            settings: {
        ...
        970928(e, t, n) {
            ...
            class y extends u.Ay.Store {
                ...
                getFetchingIds() {
                    return [...Object.entries(d).filter(e => {
                        let [, t] = e;
                        return 1 === t
                    }).map(e => {
                        let [t] = e;
            ...
            let _ = "https://i.scdn.co/image/",
                ...
                v = {
                    ...
                    [E.fg2.TWITCH]: {
                        deserialize: (e, t) => {
                            let n, r, i;
                            return n = encodeURIComponent(e), r = t[0], i = t[1], `https://static-cdn.jtvnw.net/previews-ttv/live_user_${n}-${r}x${i}.jpg`
                        },
                        serialize: e => {
                            let t = e.match(g);
            ...
            function M(e, t, n) {
                ...
                if (null != t && t.includes(":")) {
                    let [e, r] = t.split(":");
                    return e === E.fg2.TWITCH ? null == n || "number" == typeof n ? void new f.A("ApplicationAssetUtils").warn("getAssetImage: size must === [number, number] for Twitch") : v[E.fg2.TWITCH].deserialize(r, n) : Object.prototype.hasOwnProperty.call(v, e) ? v[e].deserialize(r) : void 0
                }
                if (null == e || null == t) return;
                let i = Array.isArray(n) ? Math.max(...n) : n,
                    l = "number" == typeof i ? `?size=${(0,m.kr)(i)}` : "";
                return null != window.GLOBAL_ENV.CDN_HOST ? `${location.protocol}//${window.GLOBAL_ENV.CDN_HOST}/app-assets/${e}/${t}.${r}${l}` : `${(0,a.TP)()}/applications/${e}/app-assets/${t}.${r}${l}`
            }
            async function k(e) {
                var t;
                let n, r = await (null == (n = p.getApplicationAssets(e)) || (t = n.lastUpdated, Date.now() - t > 36e5) ? A(e) : Promise.resolve(n));
                return r?.assets
            }
            ...
            async function b(e, t) {
                ...
                if (i.length > 0 && await L(e, i), function(e, t) {
                        let n = 0;
                ...
                return (l.h.dispatch({
                    ...
                    return i
                }(t, r, a, n)) ? A(e).then(() => b(e, t, n - 1)) : (l.h.dispatch({
                    type: "APPLICATION_ASSETS_FETCH_SUCCESS",
                    applicationId: e
                }), r)
            }
        ...
        316501(e, t, n) {
            ...
            class f {
                map;
                constructor(e = y) {
                    this.map = new Map(Object.entries(e).map(e => {
                        let [t, n] = e;
                        return [t, p(n)]
                    }))
                }
            ...
            async function E() {
                ...
                if (navigator.keyboard?.getLayoutMap != null) try {
            ...
            class v {
                ...
                constructor(e = {}) {
                    ...
                    null != t ? this.keyMap = t : this.keyMap = _({
                        ...e
                    }), this._initializeInternalLayoutMap(), this.keyCodeMap = this._buildKeyCodeMapFromKeyMap(), this.updateCaches(), this.save()
                }
                ...
                _buildKeyCodeMapFromKeyMap() {
                    let e = {};
                    for (let [t, n] of Object.entries(this.keyMap)) e[n] = e[n] ?? [], e[n].push({
                        keyCode: n,
                        key: t,
                ...
                addEvent(e) {
                    let t = g(e);
                    null == this._internalKeyLayoutMap && this._initializeInternalLayoutMap(), this._hasExactMatch(t) || null != t.key && "dead" !== t.key && (null == this.keyMap[t.key] ? this.keyMap[t.key] = t.keyCode : this.keyMap[t.key] !== t.keyCode && s.default.logKeyboardMismatches && d.error(`KeyboardMapper - Key code mismatch for key ${t.key}: ${this.keyMap[t.key]} !== ${t.keyCode}`), this.keyCodeMap[t.keyCode] = this.keyCodeMap[t.keyCode] ?? [], this.keyCodeMap[t.keyCode].push(t), this._internalKeyLayoutMap?.set(t.code, t.key), this.updateCaches())
                }
                updateCaches() {
                    this._setCachedKeyCodeMapEntries(), this._setCachedKeyMapEntries(), this._setCachedKeyLayoutMapEntries()
                }
                reset() {
                    this._internalKeyLayoutMap = null, this.keyMap = _({
                        ...this._defaultKeyMap
                    }), this._initializeInternalLayoutMap(), this.keyCodeMap = this._buildKeyCodeMapFromKeyMap(), this.updateCaches(), this.save()
                }
                save() {
            ...
            class S extends v {
                getKeyString(e, t) {
                    ...
                    return 0 === n.length && (n = this.cachedKeyMapEntries.filter(e => {
                        let [t, n] = e;
                        return n == n
                    }).map(e => {
                        let [n, r] = e;
                ...
                getWeightedPossibleKeyStringMatches(e, t, n) {
                    return this.cachedAllEvents.filter(r => {
                        ...
                        let a = r => {
                                let i = 0;
                                return p(r.key) === p(e) && (i += .5), null != t && r.code === t && (i += .3), null != n && r.keyCode === n && (i += .2), i
                            },
                            l = a(r);
                        return a(i) - l
                    })
            ...
            function M() {
                return null != w ? w : w = new Promise(async e => {
                    await E(), A = new S(c), document.addEventListener("keydown", e => {
                        try {
                            A?.addEvent(e)
                        } catch (t) {
            ...
            let b = window.requestIdleCallback ?? (e => setImmediate(() => e())),
                ...
                O = e => {
                    ...
                    function z(e) {
                        ...
                        null == N && j() && (N = t ? setTimeout(B, 0) : F(B, {
                            timeout: h
                        }))
                    }
                    ...
                    function $(e) {
                        let t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : x,
                            ...
                            l = {};
                        return w || (k = (0, a.A)(), l[c] = k, w = !0), o.Bo.post({
                            url: t,
                            headers: l,
                            body: {
                                token: r,
                    ...
                    function G() {
                        ...
                        return p = 0, f = 0, m = 0, g = 0, C = Number.MAX_SAFE_INTEGER, v = 0, S = 0, _ = Date.now(), E = y, $([e], d.mX.CLIENT_TELEMETRY)
                    }
                    h = D ?? 1500, K.handleConnectionOpen = function(e) {
                        let {
                            analyticsToken: t,
                            user: n
                        } = e;
                        return null != t && (r = t), null != n.id && (i = n.id), ! function() {
                            if (null != A) return;
                            let e = () => {
                                A = {
                                    type: "timeout",
                        ...
                        return null == r && null != t && (r = t, i = n, z({
                            shouldFlushOnNextTick: !1
                        })), !1
                    };
        ...
        841117(e, t, n) {
            ...
            async function l(e) {
                ...
                for (;;) try {
                    ...
                    if (console.log(e), a in n.c) throw console.log("Module was found in webpack cache so it has loaded from the network and webpack will not retry"), e;
                    if (s >= 50) throw e;
            ...
            async function a() {
                ...
                for (;;) try {
                    ...
                    if (e instanceof ReferenceError || e instanceof WebAssembly.CompileError) {
                        var s;
                        throw s = !0, window._libdiscoreUnsupportedBrowser = s, i(`Unsupported browser, skipping libdiscore, error: [${e.name}] ${e.message}`), e
                    }
                    if (a = e, delete n.c[5426], 0 == --l) throw a;
                    i(`Failed to import libdiscore-wasm, retrying... (${l} attempts left), ${a.name}: ${a.message}`), await (0, r.eU)(t)
                }
            }
        ...
        396574(e, t, n) {
            ...
            let a = parseInt(i().version ?? "0", 10),
                ...
                o = l || "Firefox" === i().name && a >= 80 || "Chrome" === i().name && a >= 37 || "Opera" === i().name && a >= 66 || "Node.js" === i().name && a >= 6 || "Electron" === i().name && a >= 1 || "Safari" === i().name && a >= 13 || "Microsoft Edge" === i().name && a >= 37,
                u = "Chrome" === i().name || "Safari" === i().name || "Firefox" === i().name && a >= 80 || "Opera" === i().name || "Microsoft Edge" === i().name,
                d = "u" > typeof RTCPeerConnection && "function" == typeof RTCPeerConnection.prototype.addTransceiver,
                c = "u" > typeof RTCRtpSender && ("transform" in RTCRtpSender.prototype || "createEncodedStreams" in RTCRtpSender.prototype),
                h = "Chrome" === i().name && a >= 58 || "Safari" === i().name && a >= 15 || "Firefox" === i().name && a >= 108,
                y = "Chrome" === i().name && a >= 72 || "Safari" === i().name && a >= 11 || "Opera" === i().name && a >= 60 || "Microsoft Edge" === i().name && a >= 79
        }
    }
]);
