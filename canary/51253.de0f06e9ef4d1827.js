        ...
        111956(t, i, n) {
            ...
            t.exports = function(t, i, n) {
                ...
                function b() {
                    var t, n, r, o = e();
                    if (T(o)) return g(o);
                    v = setTimeout(b, (t = o - d, n = o - l, r = i - t, h ? a(r, s - n) : r))
                }
                ...
                function k() {
                    ...
                    if (f = arguments, c = this, d = n, r) {
                        if (void 0 === v) return l = t = d, v = setTimeout(b, i), m ? y(t) : p;
                        if (h) return clearTimeout(v), v = setTimeout(b, i), y(d)
                    }
                    return void 0 === v && (v = setTimeout(b, i)), p
                }
                return i = o(i) || 0, r(n) && (m = !!n.leading, s = (h = "maxWait" in n) ? u(o(n.maxWait) || 0, i) : s, x = "trailing" in n ? !!n.trailing : x), k.cancel = function() {
