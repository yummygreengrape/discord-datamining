    ...
    ["15470"], {
        106778(e, t, n) {
            ...
            var u = function() {
                    ...
                    return e.prototype.getNewForces = function(e, t) {
                        ...
                        var i = this.getNewForces(e, n),
                            r = i.x,
                            o = i.y;
                        this.velocity.update(n), this.velocity.x += r, this.velocity.y += o, this.position.update(n), this.position.x += this.velocity.x * n, this.position.y += this.velocity.y * n, this.size.update(n), this.opacity.update(n), this.opacity.value = Math.max(this.opacity.value, 0), this._lastUpdatedAt = t
                    ...
                    switch (e.type) {
                        ...
                        case "oscillating":
                            ...
                            var u = C(e.start),
                                ...
                                c = C(e.duration),
                                l = C(e.direction);
                            return new h(new g(t.x, u.x, s.x, c.x, l.x, e.easingFunction), new g(t.y, u.y, s.y, c.x, l.y, e.easingFunction), e.uniformVectorValues);
                        case "oscillating-random":
                            ...
                            var f = C(e.minStart),
                                ...
                                L = C(e.minDirection),
                                V = C(e.maxDirection);
                            return new h(new g(w(n.x, i.x), w(f.x, d.x), w(p.x, v.x), w(R.x, _.x), b(L.x, V.x), x(e.easingFunctions)[0]), new g(w(n.y, i.y), w(f.y, d.y), w(p.y, v.y), w(R.y, _.y), b(L.y, V.y), x(e.easingFunctions)[0]), e.uniformVectorValues)
                    }
                }(d(d({}, e), {
                    valueType: "Vector2"
                }))
            ...
            var V = i.forwardRef(function(e, t) {
                    var a = e.className,
                        ...
                        T = i.useCallback(function() {
                            ...
                            if (null != e) {
                                ...
                                if (null != t) {
                                    t.clearRect(0, 0, e.width, e.height), null == C || C(t), N.current.forEach(function(n, i) {
                                        var r = n.confetti,
                                            o = n.spriteCanvas;
                                        r.update(c), r.draw(o, t), r.shouldDestroy(e, c) && N.current.delete(i)
                                    }), null == V || V(t), N.current.size > 0 ? S.current = O(T) : (t.clearRect(0, 0, e.width, e.height), S.current = null);
                                    var n = Date.now();
                    ...
                    var W = i.useCallback(function(e, t) {
                            N.current.set(e.id, {
                                confetti: e,
                                spriteCanvas: t
                            }), null == S.current && T()
                        ...
                        B = i.useCallback(function(e, t, n, i, o) {
                            var a, c, l, f, p, h, C, L, V = (a = null != (L = e.id) ? L : (0, r.A)(), c = d(d({
                                id: a
                            }, s), e), f = (l = function(e, t) {
                                if (null != e) {
                            ...
                            }(null != i ? i : f, o, n), new u({
                                id: a,
                                position: _(c.position),
                                velocity: _(c.velocity),
                                rotation: (C = c.rotation, function(e) {
                                    switch (e.type) {
                                        case "static":
                                            var t = R(e.value);
                                        ...
                                        case "static-random":
                                            var n = R(e.minValue),
                                                i = R(e.maxValue);
                                            return new v(new y(w(n.x, i.x)), new y(w(n.y, i.y)), new y(w(n.z, i.z)), e.uniformVectorValues);
                                        case "linear":
                                            t = R(e.value);
                                            var r = R(e.addValue);
                                            return new v(new m(t.x, r.x), new m(t.y, r.y), new m(t.z, r.z), e.uniformVectorValues);
                                        case "linear-random":
                                            n = R(e.minValue), i = R(e.maxValue);
                                            var o = R(e.minAddValue),
                                                a = R(e.maxAddValue);
                                            return new v(new m(w(n.x, i.x), w(o.x, a.x)), new m(w(n.y, i.y), w(o.y, a.y)), new m(w(n.z, i.z), w(o.z, a.z)), e.uniformVectorValues);
                                        case "oscillating":
                                            t = R(e.value);
                                            var u = R(e.start),
                                                s = R(e.final),
                                                c = R(e.duration),
                                                l = R(e.direction);
                                            return new v(new g(t.x, u.x, s.x, c.x, l.x, e.easingFunction), new g(t.y, u.y, s.y, c.z, l.y, e.easingFunction), new g(t.z, u.z, s.z, c.z, l.z, e.easingFunction), e.uniformVectorValues);
                                        case "oscillating-random":
                                            n = R(e.minValue), i = R(e.maxValue);
                                            var f = R(e.minStart),
                                                d = R(e.maxStart),
                                                ...
                                                L = R(e.minDirection),
                                                V = R(e.maxDirection);
                                            return new v(new g(w(n.x, i.x), w(f.x, d.x), w(p.x, h.x), w(C.x, _.x), b(L.x, V.x), x(e.easingFunctions)[0]), new g(w(n.y, i.y), w(f.y, d.y), w(p.y, h.y), w(C.y, _.y), b(L.y, V.y), x(e.easingFunctions)[0]), new g(w(n.z, i.z), w(f.z, d.z), w(p.z, h.z), w(C.z, _.z), b(L.z, V.z), x(e.easingFunctions)[0]), e.uniformVectorValues)
                                    }
                                }(d(d({}, C), {
                                    valueType: "Vector3"
                                }))),
                                ...
                                opacity: function(e) {
                                    ...
                                    switch (t.type) {
                                        ...
                                        case "oscillating-random":
                                            return new g(w(t.minValue, t.maxValue), w(t.minStart, t.maxStart), w(t.minFinal, t.maxFinal), w(t.minDuration, t.maxDuration), b(t.minDirection, t.maxDirection), x(t.easingFunctions)[0])
                                    }
                                }(c.opacity),
                    ...
                    return i.useEffect(function() {
                        ...
                        return e("click", G, l), e("mousedown", J, f), e("mousemove", Q, p), e("mouseup", Z, h),
                            function() {
                                window.removeEventListener("click", G), window.removeEventListener("mousedown", J), window.removeEventListener("mousemove", Q), window.removeEventListener("mouseup", Q)
                            }
                    }, [G, J, Q, Z, l, f, p, h]), i.useEffect(function() {
                        var e = P.current,
                ...
                O = i.forwardRef(function(e, t) {
                    ...
                    var y = i.useCallback(function() {
                            ...
                            null != t && null != e && (t.clearRect(0, 0, e.width, e.height), l.current.forEach(function(e, n) {
                                var i = function(i, r) {
                                    var o = u * r + 2 * r,
                                        a = s * n + 2 * n;
                                    if (t.drawImage(e.image, o, a, u, s), null != i) {
                                        for (var c, l, f = t.getImageData(o, a, u, s), d = ("#" === (c = i)[0] && (c = c.slice(1)), {
                                                r: (l = parseInt(c, 16)) >> 16 & 255,
                                                g: l >> 8 & 255,
                                                b: 255 & l
                                            }), p = 0; p < f.data.length; p += 4) f.data[p] = d.r, f.data[p + 1] = d.g, f.data[p + 2] = d.b;
                                        t.putImageData(f, o, a)
                                    }
                                };
                                e.colorize ? a.forEach(function(e, t) {
                                    return i(e, t)
                                }) : i(null, 0)
                            }))
                        }, [a, s, u]),
                    ...
                    return i.useEffect(function() {
                        ...
                        null != c.current && (c.current.width = (u + 2) * Math.max(a.length, 1), c.current.height = (s + 2) * o.length)
                    }, [a.length, s, u, o.length]), i.createElement("canvas", {
                        ref: c,
                        className: n,
            ...
            function k(e, t) {
                var n, r, o = i.useState(null != (n = null == t ? void 0 : t.isReady) && n),
                    a = o[0],
                    u = o[1],
                ...
                var f = i.useCallback(function(n, i) {
                        var r = void 0 === i ? {} : i,
                            o = r.sprite,
                            a = r.color,
                    ...
                    d = i.useCallback(function(e, t, n) {
                        for (var i = [], r = 0; r < t; r++) {
                            var o = f(e, n);
                            o && i.push(o)
                        }
        ...
        143236(e) {
            ...
            function c(e, t, n, i) {
                ...
                else if ("function" == typeof a ? a = o[t] = i ? [n, a] : [a, n] : i ? a.unshift(n) : a.push(n), (r = s(e)) > 0 && a.length > r && !a.warned) {
                    a.warned = !0;
                    var r, o, a, c = Error("Possible EventEmitter memory leak detected. " + a.length + " " + String(t) + " listeners added. Use emitter.setMaxListeners() to increase limit");
            ...
            function v(e, t, n, i) {
                ...
                else if ("function" == typeof e.addEventListener) e.addEventListener(t, function r(o) {
            ...
            Object.defineProperty(o, "defaultMaxListeners", {
                ...
                set: function(e) {
                    if ("number" != typeof e || e < 0 || r(e)) throw RangeError('The value of "defaultMaxListeners" is out of range. It must be a non-negative number. Received ' + e + ".");
                    a = e
                }
            }), o.init = function() {
                (void 0 === this._events || this._events === Object.getPrototypeOf(this)._events) && (this._events = Object.create(null), this._eventsCount = 0), this._maxListeners = this._maxListeners || void 0
            }, o.prototype.setMaxListeners = function(e) {
                if ("number" != typeof e || e < 0 || r(e)) throw RangeError('The value of "n" is out of range. It must be a non-negative number. Received ' + e + ".");
                ...
                if ("function" == typeof s) i(s, this, t);
                    ...
                    for (var c = s.length, l = h(s, c), n = 0; n < c; ++n) i(l[n], this, t);
                return !0
                ...
                var n, i, r, o, a;
                if (u(t), void 0 === (i = this._events) || void 0 === (n = i[e])) return this;
