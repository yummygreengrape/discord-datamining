        ...
        565645(e, t, n) {
            ...
            function N(e) {
                let {
                    ...
                    surrogate: E,
                    ...z
                } = e, [I, M] = s.useState(!1), [F, U] = s.useState(void 0), _ = s.useRef(void 0), {
                    triggerAnimation: L,
                    untriggerAnimation: V
                } = s.useContext(d.wE), B = g.Sf.useSetting(), T = v(), Y = null == x ? B : x, D = C.Ec[N], O = s.useRef(null), P = s.useMemo(() => {
                    if (null != t) return t;
                    if (null != a) {
                        let e = !0 === j && Y;
                ...
                }, [f, Y, a, u, D, T, I, A, j, t]), W = s.useCallback(() => {
                    null != P && (_.current = (0, m.yt)(P, e => {
                        e || U(Date.now())
                    }))
                }, [P]), q = s.useCallback(e => {
                    f && M(!0), null == a && L(u), w?.(e)
                }, [f, u, w, L, a]), G = s.useCallback(e => {
            ...
            function j(e) {
                return null == e.emojiId && null == e.emojiName && null == e.src ? null : e.animated && void 0 === e.shouldAnimate ? (0, i.jsx)(A, {
                    ...e
                }) : (0, i.jsx)(N, {
                    ...e
                })
        ...
        830178(e, t, n) {
            ...
            class o {
                    ...
                    this.observer = new window.IntersectionObserver(e => {
                        (0, r.r)(() => {
                            e.forEach(e => {
                                ...
                                null == t || (e.intersectionRatio >= .7 ? this.handleVisible(e, t) : this.handleNotVisible(e, t))
                            })
                        })
                    }, {
                        threshold: .7
                ...
                handleVisible(e, t) {
                    ...
                    let n = Math.abs(e.intersectionRect.bottom - Number(e.rootBounds?.bottom)) < Math.abs(e.intersectionRect.top - Number(e.rootBounds?.top));
                    n ? this.visibleComponents = new Set([e.target, ...this.visibleComponents]) : this.visibleComponents.add(e.target);
                    let i = n || this.animatingComponents.size < 100;
                    i ? this.animatingComponents.add(e.target) : this.animatingComponents.delete(e.target), t.updateState(i), i && this.visibleComponents.size > 100 && this.stopNodeFromAnimating()
                }
                ...
                unregisterNode(e) {
                    this.registeredNodes.delete(e), this.animatingComponents.delete(e), this.visibleComponents.delete(e), this.observer?.unobserve(e), this.potentiallyAnimateNewNode()
                }
                cleanUp() {
            ...
            function l(e) {
                ...
                return s.useEffect(() => () => n.manager.cleanUp(), [n.manager]), (0, i.jsx)(a.Provider, {
                    value: n,
                    children: t
                })
            }
