(() => {
    ...
    var e, t, n, r, i = {
            668964(e, t, n) {
                ...
                if (null != L) {
                    ...
                    if (r = {
                        ...
                        }, A().name?.toLocaleLowerCase() === "electron" && (r.browser_user_agent = A().ua || "", r.browser_version = A().version || ""), "linux" === n) {
                    ...
                    } else "darwin" === n ? r.os_sdk_version = i?.split(".")[0] : "win32" === n && (r.os_sdk_version = i?.split(".")[2])
                }
                ...
                function f() {
                    var e;
                    let t, n, r = {};
                    return r.referrer = document.referrer, r.referring_domain = (t = document.referrer.split("/")).length >= 3 ? t[2] : "", {
                        ...r,
                        ...(e = window.location.href, n = {}, p.forEach(t => {
                            let r = C(e, t);
                            r.length > 0 && (n[t] = r)
                        }), n),
                        ... function() {
                            let e, t = {},
                                n = document.referrer,
                                r = 0 === (e = document.referrer).search("https?://(.*)google.([^/?]*)") ? "google" : 0 === e.search("https?://(.*)bing.com") ? "bing" : 0 === e.search("https?://(.*)yahoo.com") ? "yahoo" : 0 === e.search("https?://(.*)duckduckgo.com") ? "duckduckgo" : null;
                            if (null != r) {
                                t.search_engine = r;
                ...
                if (null == r) try {
                    r = function() {
                        ...
                        if (null == e) {
                            ...
                            }(), t.system_locale = (0, S.c)(), t.has_client_mods = (0, O.b)(), e = t, c.w.set(u, e)
                        }
                        let t = c.w.get(d);
                ...
                o = {}, (_ = window.GLOBAL_ENV.RELEASE_CHANNEL) && (null == o.release_channel || "" === o.release_channel) && (o.release_channel = _.split("-")[0]), isNaN(s = parseInt("536927", 10)) || (o.client_build_number = s), null == (l = L?.app.getBuildNumber()) || isNaN(l) || (o.native_build_number = l), o.client_event_source = function() {
                    try {
                        if (__OVERLAY__) return "OVERLAY"
                    } catch (e) {}
                    return null
                }(), o.has_client_mods = (0, O.b)(), o.client_launch_id = N.C, r = {
                    ...r,
                    ...o
                }, (0, T.q)(r);
                var G = n(824120),
                ...
                class P {
                    ...
                    static fromString(e) {
                        return new P(function(e) {
                            let t = g(e),
                                n = [, , , , ];
                            for (let e = 0; e < 4; e++) n[3 - e] = function(e, t) {
                                let n = 0;
                                for (let r = 0; r < 4; r++) {
                                    let i = e[t + r];
                                    if (void 0 === i) break;
                ...
                M && null == BigInt.prototype.toJSON && (BigInt.prototype.toJSON = function() {
                    return this.toString()
                });
                let m = {},
                    h = (M ? function(e) {
                ...
                }(v.KICK_MEMBERS, v.BAN_MEMBERS, v.ADMINISTRATOR, v.MANAGE_CHANNELS, v.MANAGE_GUILD, v.MANAGE_ROLES, v.MANAGE_MESSAGES, v.MANAGE_THREADS, v.MODERATE_MEMBERS), Object.freeze({
                ...
                var H = ((I = H || {}).INDEX = "/", I.INDEX_WORD = "/index", I.INDEX_BUCKET = "/index/:bucketId", I.CHANGELOGS = "/changelogs/:date", I.COMMUNITY = "/community", I.COMPANY = "/company", I.COMPANY_INFORMATION = "/company-information", I.CREATORS = "/creators", I.DOWNLOADS = "/downloads", I.DOWNLOAD = "/download", I.GAMING = "/gaming", I.PRIVACY = "/privacy", I.TOS = "/tos", I.TERMS = "/terms", I.STORE_TERMS = "/store-terms", I.ACKNOWLEDGEMENTS = "/acknowledgements", I.LICENSES = "/licenses", I.PARTNERS = "/partners", I.HYPESQUAD = "/hypesquad", I.HYPESQUAD_RIOT = "/hypesquad-riot", I.BRANDING = "/branding", I.ERROR_404 = "/404", I.JOBS = "/jobs", I.JOB = "/jobs/:jobId", I.STREAMKIT = "/streamkit", I.SECURITY = "/security", I.NITRO = "/nitro", I.DISCOVER = "/servers", I.QUESTS = "/ads/quests", I.GUIDELINES = "/guidelines", I.RICH_PRESENCE = "/rich-presence", I.VERIFICATION = "/verification", I.OPEN_SOURCE = "/open-source", I.WARFRAME = "/warframe", I.REMOTE_AUTH = "/ra/:remoteAuthFingerprint", I.SAFETY_LANDING = "/safetycenter", I.SAFETY_ARTICLE_ROOT = "/safety", I.SAFETY_ARTICLE = "/safety/:article", I.NEWSROOM = "/newsroom", I.INSPIRATION = "/inspiration", I.MOD_ACADEMY_LANDING = "/moderation", I.MOD_ACADEMY_EXAM = "/moderation/exam", I.MOD_ACADEMY_ARTICLE = "/moderation/:article", I.BLOG = "/blog", I.BUILD = "/build", I.DEVELOPERS = "/developers", I.APP_DIRECTORY = "/application-directory", I.REFRESH_INDEX = "/new", I.REFRESH_INDEX_WORD = "/new/index", I.REFRESH_COMPANY = "/new/company", I.REFRESH_DOWNLOAD = "/new/download", I.REFRESH_PRIVACY = "/new/privacy", I.REFRESH_TERMS = "/new/terms", I.REFRESH_ACKNOWLEDGEMENTS = "/new/acknowledgements", I.REFRESH_LICENSES = "/new/licenses", I.REFRESH_BRANDING = "/new/branding", I.REFRESH_JOBS = "/new/jobs", I.REFRESH_JOB = "/new/jobs/:jobId", I.REFRESH_STREAMKIT = "/new/streamkit", I.REFRESH_NITRO = "/new/nitro", I.REFRESH_GUIDELINES = "/new/guidelines", I.REFRESH_SAFETY_LANDING = "/new/safety", I.REFRESH_SAFETY_ARTICLE = "/new/safety/:article", I.COLLEGE = "/college", I.LEAGUE_CLUBS = "/league-communities", I.DISCORD_RECRUITING_SCAMS = "/discord-recruitment-scams", I.DEV_NEWSLETTER_SIGNUP = "/dev-newsletter", I.LEGACY_DEV_NEWSLETTER = "/newsletter", I.LEGAL_ARCHIVE = "/archive/", I.TERMS_MAY_2020 = "/archive/terms/may-2020", I.PRIVACY_JUNE_2020 = "/archive/privacy/june-2020", I.GUIDELINES_MAY_2020 = "/archive/guidelines/may-2020", I.FALL_RELEASE_2023 = "/fallrelease", I.MOBILE_REDESIGN_2023 = "/mobile", I.REFRESH_XBOX_OFFER = "/new/discord-xbox-offer-2019", I.REFRESH_WHY_DISCORD = "/why-discord-is-different", I.WHY_DISCORD = "/why-discord", I.XBOX_OFFER = "/discord-xbox-offer-2020", I.COLLEGE_BRUINS = "/bruins", I.COLLEGE_ANTEATERS = "/anteaters", I.COLLEGE_GAUCHOS = "/gauchos", I.COLLEGE_BEARS = "/bears", I.COLLEGE_SLUGS = "/slugs", I.BACK_TO_SCHOOL_GIVEAWAY_INSTAGRAM = "/terms/back-to-school-2020/instagram", I.BACK_TO_SCHOOL_GIVEAWAY_TWITTER = "/terms/back-to-school-2020/twitter", I.SNOWSGIVING_GIVEAWAY_INSTAGRAM = "/terms/snowsgiving-2020/instagram", I.SNOWSGIVING_GIVEAWAY_TWITTER = "/terms/snowsgiving-2020/twitter", I);
                (0, U.dN)(y), (0, U.dN)(H), Object.freeze({
                ...
                function x(e) {
                    return null == e || 0 === e.length ? {
                        ...
                        decryptedToken: F.decryptString(e.substring(Y.length)),
                        wasEncrypted: !0
                    } : {
                        decryptedToken: e,
                        wasEncrypted: !1
                ...
                ! function() {
                    ...
                    let e = (function() {
                        ...
                        W = t, i = e, [...Object.entries(k).map(e => {
                            let [t, n] = e, {
                                decryptedToken: r,
                                wasEncrypted: i
                            } = x(n);
                    ...
                    let t = window._ws.ws,
                        n = window._ws.state;
                    t.onopen = function() {
                        if (n.open = !0, !(0, q.Q)(window.location.pathname)) return void console.log("[FAST CONNECT] session is not required, skipping fast connect early identify");
                        console.log("[FAST CONNECT] sending identify");
                        let i = e => JSON.stringify(e);
                        if (null != window.DiscordNative) {
                            let e, t = window.DiscordNative;
                            try {
                        ...
                        var o = i({
                            ...
                            d: {
                                token: e,
                                capabilities: (0, j.O)({
                                    useChannelObfuscation: null != c.w.get("private_channel_obfuscation")
                                }),
                                properties: {
                                    ...r,
                                    is_fast_connect: !0,
            ...
            746080(e, t, n) {
                ...
                let E = new Set(Object.values(((r = {}).ROLE_SUBSCRIPTIONS = "role-subscriptions", r.SERVER_MONETIZATION_ONBOARDING = "server-monetization-onboarding", r.GAME_SHOP = "game-shop", r.GUILD_SHOP = "shop", r.MEMBER_APPLICATIONS = "member-applications", r.GUILD_HOME = "@home", r.CHANNEL_BROWSER = "channel-browser", r.GUILD_ONBOARDING = "onboarding", r.CUSTOMIZE_COMMUNITY = "customize-community", r.MEMBER_SAFETY = "member-safety", r.GUILD_BOOSTS = "boosts", r.GAME_SERVERS = "game-servers", r.REPORT_TO_MOD = "report-to-mod", r)));
                Object.freeze({
                ...
                }), Object.values(((i = {}).GUILD_HOME = "home", i.SERVER_GUIDE = "guide", i.CHANNEL_BROWSER = "browse", i.CUSTOMIZE_COMMUNITY = "customize", i.LINKED_ROLES = "linked-roles", i))
            },
            435220(e, t, n) {
                n.d(t, {
                ...
                var r, i, E = ((r = {}).ABOUT = "about", r.STORE = "store", r),
                    o = ((i = {}).GENERAL = "general", i.IMAGES = "images", i.PREMIUM_DEPRECATED = "premium", i.STORE = "store", i.PRIVACY = "privacy", i)
            },
            901123(e, t, n) {
                n.d(t, {
                    BV: () => _,
                ...
                n(436317);
                var i = n(435220);
                let E = ["@me", "@favorites", "@guilds-empty-nux", "@inbox", "@guild-upsell-list"],
                    o = Object.freeze({
                        INDEX: "/",
                        APP: "/app",
                        ...
                        CHANNEL: (e, t, n) => {
                            let r = null == t ? `/channels/${e||"@me"}` : `/channels/${e||"@me"}/${t}`;
                            return null == n ? r : `${r}/${n}`
                        },
                        ...
                        GLOBAL_DISCOVERY_APPS_PROFILE_STORE_SKU: (e, t) => `/discovery/applications/${e}/${i.GlobalDiscoveryAppsSections.STORE}/${t}`,
                        ...
                        BILLING_MANAGE_SUBSCRIPTION_WITH_DEEP_LINK: (e, t) => `/billing/premium/manage?deep_link_type=${e}${null!=t?`&load_id=${t}`:""}`,
                        BILLING_MANAGE_SUBSCRIPTION_WITH_FLOW_TYPE: (e, t) => `/billing/premium/manage?flow_type=${e}${null!=t?`&load_id=${t}`:""}`,
                        BILLING_STANDALONE_CHECKOUT_PAGE: (e, t, n, r, i, E, o) => `/billing/premium/subscribe?plan_id=${e}&gift=${t}&load_id=${n}${null!=r?`&payment_method_type=${r}`:""}${null!=i?`&deep_link_type=${i}`:""}${null!=E?`&use_preset_offer=${E}`:""}${null!=o?`&flow_type=${o}`:""}`,
                        BILLING_STANDALONE_GUILD_BOOST_CHECKOUT_PAGE: (e, t, n, r) => `/billing/guild-subscriptions/purchase?guild_id=${e}${null!=t?`&deep_link_type=${t}`:""}${null!=n?`&load_id=${n}`:""}${null!=r?`&flow_type=${r}`:""}`,
                        ...
                        APPLICATION_DIRECTORY_PROFILE_STORE_SKU: (e, t) => `/application-directory/${e}/${i.ApplicationDirectoryProfileSections.STORE}/${t}`,
                    ...
                    for (let i of Object.keys(e)) {
                        ...
                        n[i] = function() {
                            ...
                            return E(... function(e, t) {
                                return e.map(e => null == e ? e : e instanceof r ? e.toString() : null == t ? encodeURIComponent(e) : String(e).split("").map(e => null != t && t.includes(e) ? e : encodeURIComponent(e)).join(""))
                            }(n, t))
                        }
                    }
                    return n
    ...
    o.m = i, o.n = e => {
    ...
    })(), o.o = (e, t) => Object.prototype.hasOwnProperty.call(e, t), o.nmd = e => (e.paths = [], e.children || (e.children = []), e), e = [], o.O = (t, n, r, i) => {
        if (n) {
            i = i || 0;
            for (var E = e.length; E > 0 && e[E - 1][2] > i; E--) e[E] = e[E - 1];
            e[E] = [n, r, i];
            return
        }
        for (var _ = 1 / 0, E = 0; E < e.length; E++) {
            for (var [n, r, i] = e[E], s = !0, l = 0; l < n.length; l++)(!1 & i || _ >= i) && Object.keys(o.O).every(e => o.O[e](n[l])) ? n.splice(l--, 1) : (s = !1, i < _ && (_ = i));
            if (s) {
                e.splice(E--, 1);
                var I = r();
                void 0 !== I && (t = I)
        ...
        var r, i, [E, _, s] = n,
            l = 0;
        if (E.some(e => 0 !== t[e])) {
            for (r in _) o.o(_, r) && (o.m[r] = _[r]);
            if (s) var I = s(o)
        }
        for (e && e(n); l < E.length; l++) i = E[l], o.o(t, i) && t[i] && t[i][0](), t[i] = 0;
        return o.O(I)
    }, (r = this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).forEach(n.bind(null, 0)), r.push = n.bind(null, r.push.bind(r)), o.ruid = "bundler=rspack@1.7.11";
    var _ = o.O(void 0, ["48255", "1028", "42755", "40060", "11439", "62412", "99286", "24992", "86068", "7751", "52906", "27694", "82058", "97851"], () => o(668964));
    _ = o.O(_)
})();
//# sourceMappingURL=fast-connect.07c7371d530ac6ce.js.map