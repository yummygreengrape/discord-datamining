...
(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    ["65006"], {
        830845(n, t, e) {
            ...
            function s(n, t) {
                return 0 === n.toLowerCase().indexOf(t.toLowerCase()) && -1 !== "/?#".indexOf(n.charAt(t.length)) ? n.substr(t.length) : n
            }
            ...
            function d(n, t, e, r) {
                var a, c, u, s, f, h;
                "string" == typeof n ? (u = "", s = "", -1 !== (f = (c = n || "/").indexOf("#")) && (s = c.substr(f), c = c.substr(0, f)), -1 !== (h = c.indexOf("?")) && (u = c.substr(h), c = c.substr(0, h)), (a = {
                    pathname: c,
                    search: "?" === u ? "" : u,
                    hash: "#" === s ? "" : s
                }).state = t) : (void 0 === (a = (0, o.A)({}, n)).pathname && (a.pathname = ""), a.search ? "?" !== a.search.charAt(0) && (a.search = "?" + a.search) : a.search = "", a.hash ? "#" !== a.hash.charAt(0) && (a.hash = "#" + a.hash) : a.hash = "", void 0 !== t && void 0 === a.state && (a.state = t));
                try {
                    a.pathname = decodeURI(a.pathname)
                } catch (n) {
                    if (n instanceof URIError) throw URIError('Pathname "' + a.pathname + '" could not be decoded. This is likely caused by an invalid percent-encoding.');
                    throw n
                }
                return e && (a.key = e), r ? a.pathname ? "/" !== a.pathname.charAt(0) && (a.pathname = (0, i.A)(a.pathname, r.pathname)) : a.pathname = r.pathname : a.pathname || (a.pathname = "/"), a
            }
            ...
            function O(n) {
                ...
                function I(n) {
                    R ? (R = !1, C()) : E.confirmTransitionTo(n, "POP", A, function(t) {
                        var e, o, i, r, a;
                        t ? C({
                            action: "POP",
                            location: n
                        }) : (e = n, o = z.location, -1 === (i = M.indexOf(o.key)) && (i = 0), -1 === (r = M.indexOf(e.key)) && (r = 0), (a = i - r) && (R = !0, F(a)))
                    })
                }
                var H = T(y()),
                    M = [H.key];
                ...
                function _(n) {
                    1 === (B += n) && 1 === n ? (window.addEventListener(g, S), r && window.addEventListener(m, U)) : 0 === B && (window.removeEventListener(g, S), r && window.removeEventListener(m, U))
                }
                var q = !1,
                    z = {
                        length: e.length,
                                ...
                                if (n) {
                                    ...
                                    if (i)
                                        if (e.replaceState({
                                            ...
                                            var u = M.indexOf(z.location.key); - 1 !== u && (M[u] = r.key), C({
                                                action: o,
                                                location: r
                                            })
                                        }
            ...
            function T(n) {
                ...
                function S() {
                    ...
                    if (n !== t) k(t);
                        ...
                        C = null, e = o, E ? (E = !1, L()) : T.confirmTransitionTo(e, "POP", r, function(n) {
                            var t, o, i, r, a;
                            n ? L({
                                action: "POP",
                                location: e
                            }) : (t = e, o = _.location, -1 === (i = H.lastIndexOf(h(o))) && (i = 0), -1 === (r = H.lastIndexOf(h(t))) && (r = 0), (a = i - r) && (E = !0, M(a)))
                        })
                    }
                }
                var U = b(),
                            ...
                            T.confirmTransitionTo(o, e, r, function(n) {
                                if (n) {
                                    var t = h(o),
                                        i = m(l + t);
                                    b() !== i && (C = t, k(i));
                                    var r = H.indexOf(h(_.location)); - 1 !== r && (H[r] = t), L({
                                        action: e,
                                        location: o
                                    })
                                }
                    ...
                    push: function(n, t) {
                        ...
                        s.confirmTransitionTo(i, o, e, function(n) {
                            if (n) {
                                var t = m.index + 1,
                                    e = m.entries.slice(0);
                                e.length > t ? e.splice(t, e.length - t, i) : e.push(i), f({
                                    action: o,
                                    location: i,
                                    index: t,
                                    entries: e
        ...
        987701(n, t, e) {
            ...
            let i = function n(t, e) {
                ...
                if ("object" == typeof t || "object" == typeof e) {
                    var i = o(t),
                        r = o(e);
                    return i !== t || r !== e ? n(i, r) : Object.keys(Object.assign({}, t, e)).every(function(o) {
                        return n(t[o], e[o])
                    })
                }
                return !1
