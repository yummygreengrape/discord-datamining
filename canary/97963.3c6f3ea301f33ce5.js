            ...
            t.parse = function(r, t) {
                ...
                return a.forEach(function(r) {
                    ...
                    if (!(t < 0)) {
                        ...
                        '"' == n[0] && (n = n.slice(1, -1)), void 0 == e[i] && (e[i] = function(r, t) {
                            try {
                                return t(r)
                            } catch (t) {
                                return r
                ...
                return n.expires && p.push("Expires=" + n.expires.toUTCString()), n.httpOnly && p.push("HttpOnly"), n.secure && p.push("Secure"), n.firstPartyOnly && p.push("First-Party-Only"), p.join("; ")
            };
